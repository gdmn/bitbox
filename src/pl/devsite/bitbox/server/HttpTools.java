...
//        }
    ...
    public static String base64encode(String string) {
        ...
        /*
        // base64 encode from http://www.wikihow.com/Encode-a-String-to-Base64-With-Java
        ...
        byte[] padded = new byte[stringArray.length + paddingCount]; // initialized to zero by JVM
    ...
    public static String getDefaultCSS() {
        if (defaultCSS == null) {
            String[] css = {
                /* font-family: Helvetica, Calibri, Arial, "Nimbus Sans L", sans-serif
                 * font-family: Corbel, Verdana, "Bitstream Vera Sans", "DejaVu Sans", sans-serif
                 * font-family: Candara, "Trebuchet MS", Trebuchet, sans-serif *no good Trebuchet-ish Linux font*
                 * font-family: Cambria, "Times New Roman", Times, FreeSerif, serif
                 * font-family: Constantia, "Palatino Linotype", Palatino, Georgia, "Century Schoolbook L", serif
                 * font-family: Consolas, "Bitstream Vera Sans Mono", "Courier New", Courier, "Nimbus Mono L", monospace
                 */
                "<style type=\"text/css\">",
                "/* <![CDATA[ */",
                "body {",
